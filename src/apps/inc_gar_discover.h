#ifndef EXAMPLES_ANALYTICAL_APPS_INC_GAR_DISCOVER_H_
#define EXAMPLES_ANALYTICAL_APPS_INC_GAR_DISCOVER_H_
...
#include "rule_discover/inc_gar_discover.h"
#include "timer.h"
...
void Run() {
  ...
  using AppType = IncGarDiscover<GraphType>;
...
#endif  // EXAMPLES_ANALYTICAL_APPS_INC_GAR_DISCOVER_H_
