...
DEFINE_bool(segmented_partition, false,
...
DEFINE_string(pattern_v_file, "", ".v csv of pattern");
DEFINE_string(pattern_e_file, "", ".e csv of pattern");

DEFINE_string(yaml_file, "", "path of input yaml file");

DEFINE_bool(load_whole_graph, false, "each process load whole graph");
